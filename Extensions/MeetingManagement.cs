namespace AdobeConnectSDK.Extensions
{
    ...
    public static class MeetingManagement
    {
        ...
        /// </returns>
        public static async Task<EnumerableResultStatus<MeetingItem>> GetAllMeetings(this AdobeConnectXmlAPI adobeConnectXmlApi)
        {
            return await GetAllMeetings(adobeConnectXmlApi, null);
        }
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<MeetingItem>> GetAllMeetings(this AdobeConnectXmlAPI adobeConnectXmlApi, string likeName)
        {
            ...
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-bulk-objects", "filter-type=meeting" + filterName);
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<MeetingItem>> GetMeetingsInRoom(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("sco-contents", String.Format("sco-id={0}", scoId));
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<MeetingDetailStatus> GetMeetingDetail(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("sco-info", String.Format("sco-id={0}", scoId));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> MeetingUpdate(this AdobeConnectXmlAPI adobeConnectXmlApi, MeetingUpdateItem meetingUpdateItem)
        {
            if (meetingUpdateItem == null)
                return null;
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<XElement>> GetMeetingsInRoomRaw(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("sco-contents", String.Format("sco-id={0}", scoId));
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<ScoShortcut>> GetMeetingShotcuts(this AdobeConnectXmlAPI adobeConnectXmlApi)
        {
            EnumerableResultStatus<ScoShortcut> itemData = await GetSCOshotcuts(adobeConnectXmlApi);
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<MeetingItem>> GetMyMeetings(this AdobeConnectXmlAPI adobeConnectXmlApi)
        {
            return await GetMyMeetings(adobeConnectXmlApi, null);
        }
        ...
        /// </returns>
        public static async Task<ApiStatus> GetQuizzesInRoom(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("sco-contents", String.Format("sco-id={0}", scoId));
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<ScoShortcut>> GetSCOshotcuts(this AdobeConnectXmlAPI adobeConnectXmlApi)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("sco-shortcuts", null);
