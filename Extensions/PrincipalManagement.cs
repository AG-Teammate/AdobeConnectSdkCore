namespace AdobeConnectSDK.Extensions
{
    ...
    public static class PrincipalManagement
    {
        ...
        public static async Task<PrincipalInfoStatus> GetPrincipalInfo(this AdobeConnectXmlAPI adobeConnectXmlApi, string principalId)
        {
            if (String.IsNullOrEmpty(principalId))
                throw new ArgumentNullException("principalId");

            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("principal-info", String.Format("principal-id={0}", principalId));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> PrincipalDelete(this AdobeConnectXmlAPI adobeConnectXmlApi, string[] principalId)
        {
            ...
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("principals-delete", String.Join("&", principalId));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> PrincipalUpdatePwd(this AdobeConnectXmlAPI adobeConnectXmlApi, string userId, string passwordOld, string password)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("user-update-pwd", String.Format("user-id={0}&password-old={1}&password={2}", userId, passwordOld, password));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> PrincipalGroupMembershipUpdate(this AdobeConnectXmlAPI adobeConnectXmlApi, string groupId, string principalId, bool isMember)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("group-membership-update", String.Format("group-id={0}&principal-id={1}&is-member={2}", groupId, principalId, isMember ? 1 : 0));
        ...
        /// </returns>
        public static async Task<EnumerableResultStatus<PrincipalListItem>> GetPrincipalList(this AdobeConnectXmlAPI adobeConnectXmlApi, string groupId, string filterBy)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("principal-list", String.Format("group-id={0}&{1}", groupId, filterBy));
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<PrincipalListItem>> GetPrincipalList(this AdobeConnectXmlAPI adobeConnectXmlApi)
        {
            return await adobeConnectXmlApi.GetPrincipalList(String.Empty, String.Empty);
        }
        ...
        ///   <see cref="EnumerableResultStatus{T}" />
        /// </returns>
        public static async Task<EnumerableResultStatus<PermissionInfo>> GetPermissionsInfo(this AdobeConnectXmlAPI adobeConnectXmlApi, string aclId, string principalId, string filter)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("permissions-info", String.Format("acl-id={0}&principal-id={1}&filter-definition={2}", aclId, principalId, filter));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> PermissionsReset(this AdobeConnectXmlAPI adobeConnectXmlApi, string aclId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("permissions-reset", String.Format("acl-id={0}", aclId));
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> PermissionsUpdate(this AdobeConnectXmlAPI adobeConnectXmlApi, string aclId, string principalId, PermissionId permissionId)
        {
            ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("permissions-update", String.Format("acl-id={0}&principal-id={1}&permission-id={2}", aclId, principalId, Helpers.EnumToString(permissionId)));
        ...
        public static async Task<ApiStatus> SpecialPermissionsUpdate(this AdobeConnectXmlAPI adobeConnectXmlApi, string aclId, SpecialPermissionId permissionId)
        {
            switch (permissionId)
            {
                case SpecialPermissionId.Denied:
                    return await PermissionsUpdate(adobeConnectXmlApi, aclId, "public-access", PermissionId.Denied);
                case SpecialPermissionId.Remove:
                    return await PermissionsUpdate(adobeConnectXmlApi, aclId, "public-access", PermissionId.Remove);
                case SpecialPermissionId.ViewHidden:
                    return await PermissionsUpdate(adobeConnectXmlApi, aclId, "public-access", PermissionId.ViewHidden);
                default:
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> ParticipantSubscribe(this AdobeConnectXmlAPI adobeConnectXmlApi, string courseSco, string principalId)
        {
            return await PermissionsUpdate(adobeConnectXmlApi, courseSco, principalId, PermissionId.View);
        }
        ...
        ///   <see cref="ApiStatus" />
        /// </returns>
        public static async Task<ApiStatus> ParticipantUnsubscribe(this AdobeConnectXmlAPI adobeConnectXmlApi, string courseSco, string principalId)
        {
            return await PermissionsUpdate(adobeConnectXmlApi, courseSco, principalId, PermissionId.Remove);
        }
    }
}
