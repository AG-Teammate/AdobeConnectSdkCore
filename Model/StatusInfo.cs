...
namespace AdobeConnectSDK.Model
{
    ...
    public class ApiStatusWithMeetingDetail : ApiStatus
    {
        public MeetingDetail MeetingDetail { get; set; }

        public static ApiStatusWithMeetingDetail FromApiStatus(ApiStatus status)
        {
            return AutoMapper.Mapper.Map<ApiStatusWithMeetingDetail>(status);
        }
    }

    public class ApiStatusWithPrincipal : ApiStatus
    {
        public Principal Principal { get; set; }

        public static ApiStatusWithPrincipal FromApiStatus(ApiStatus status)
        {
            return AutoMapper.Mapper.Map<ApiStatusWithPrincipal>(status);
        }
    }

    public class ApiStatusWithSco : ApiStatus
    {
        public Sco Sco { get; set; }

        public static ApiStatusWithSco FromApiStatus(ApiStatus status)
        {
            return AutoMapper.Mapper.Map<ApiStatusWithSco>(status);
        }
    }
