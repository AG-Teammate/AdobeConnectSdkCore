namespace AdobeConnectSDK.Extensions
{
    ...
    public static class Reporting
  {
    ...
    /// </returns>
    public static async Task<EnumerableResultStatus<EventInfo>> ReportMyEvents(this AdobeConnectXmlAPI adobeConnectXmlApi)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-my-events", null);
    ...
    /// </returns>
    public static async Task<QuotaInfoStatus> Report_Quotas(this AdobeConnectXmlAPI adobeConnectXmlApi)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quotas", String.Empty);
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_BulkQuestions(this AdobeConnectXmlAPI adobeConnectXmlApi, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-bulk-questions", String.Format("{0}", filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<TransactionInfo>> Report_ConsolidatedTransactions(this AdobeConnectXmlAPI adobeConnectXmlApi, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-bulk-consolidated-transactions", filterBy);
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizInteractions(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-interactions", String.Format("sco-id={0}&{1}", scoId, filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizQuestionAnswers(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-question-answer-distribution", String.Format("sco-id={0}&{1}", scoId, filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizQuestionDistribution(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-question-distribution", String.Format("sco-id={0}&{1}", scoId, filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizQuestionResponse(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-question-response", String.Format("sco-id={0}&{1}", scoId, filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizSummary(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-summary", String.Format("sco-id={0}", scoId));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_QuizTakers(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-quiz-takers", String.Format("sco-id={0}&{1}", scoId, filterBy));
    ...
    ///   <see cref="EnumerableResultStatus{T}" />
    /// </returns>
    public static async Task<EnumerableResultStatus<XElement>> Report_MeetingAttendance(this AdobeConnectXmlAPI adobeConnectXmlApi, string scoId, string filterBy)
    {
      ApiStatus s = await adobeConnectXmlApi.ProcessApiRequest("report-meeting-attendance", String.Format("sco-id={0}&{1}", scoId, filterBy));
